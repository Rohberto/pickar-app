...
export default function DriverSignupScreen() {
  ...
  const validate = () => {
    ...
    if (!formData.idDocument) {
      newErrors.idDocument = 'Valid ID document is required';
    }
        ...
        >
          <Animated.View style={[styles.content, { opacity: fadeAnim }]}>
            ...
            <Text style={styles.subtitle}>
              Fill your information and upload required{'\n'}documents to register as a driver
            </Text>
            ...
            <View style={styles.form}>
              ...
              <DocumentUpload
                ...
                onSelect={(uri) =>
                  setFormData({ ...formData, idDocument: uri })
                }
              ...
              <DocumentUpload
                ...
                onSelect={(uri) =>
                  setFormData({ ...formData, proofOfAddress: uri })
                }
